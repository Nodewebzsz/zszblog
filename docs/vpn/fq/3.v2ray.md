...
####1. 国内可以直接使用如下脚本
```shell
# 访问：https://raw.githubusercontent.com/233boy/v2ray/master/install.sh 得到如下结果
#!/bin/bash
...
##3. 各平台客户端展开目录
```shell
Win V2rayN：https://github.com/2dust/v2rayN/releases/latest 记得选择 v2rayN-Core.zip 下载，不然还得单独下载 core（下面 “坑二” 有讲到） 规则推荐：https://github.com/Loyalsoldier/v2ray-rules-dat
MAC V2RayX：https://github.com/Cenmrev/V2RayX
ios shadowrockets
安卓 v2rayNG：https://github.com/2dust/v2rayNG/releases v2flyNG
```
##4. 使用方法
```shell
# 执行脚本，
...
---------- V2Ray 配置信息 -------------
 ...
 地址 (Address) = 52.53.223.25

 端口 (Port) = 45522

 用户ID (User ID / UUID) = 3f002968-f909-44e6-8452-bea3af7edcb5
...
vmess:
...
```
![v2ray1](../../../assets/images/v2ray1.png)

##6. 解压缩，启动
```shell
# 将下载完的zip文件解压缩，然后双击v2rayN.exe运行
```
![v2ray2](../../../assets/images/v2ray2.png)

##7. 导入
```shell
# 点击左上角的服务器，在下拉列表中选择从剪贴板导入url，就是将第4步生成的url导入！
```
![v2ray3](../../../assets/images/v2ray3.png)

```shell
# 导入的信息如下
```
![v2ray4](../../../assets/images/v2ray4.png)

##8. 启动代理
```shell
# 在电脑的右下角，找到v2ray图标，然后右键点击它，然后选择系统代理，选择第二项自动配置代理！
```
![v2ray5](../../../assets/images/v2ray5.png)

```shell
# 设置完成后，图标变为红色，此时说明成功!
```
![v2ray6](../../../assets/images/v2ray6.png)

##9. 验证
```shell
# google.com
```
![v2ray7](../../../assets/images/v2ray7.png)
